...
namespace ST_GROUP.Blog
{
    ...
    ///   ST_save 的摘要说明。
    /// </summary>
    public partial class ST_save : Page
    {
        ...
        public void ST_Save_Add()
        {
			...
			*/
            string ST_sql =
                "insert into ST_news (ST_n_author,ST_n_title,ST_n_key,ST_n_content,ST_c_id,ST_n_iscmd) values ('" +
                ST_n_author + "','" + ST_n_title + "','" + ST_n_key + "','" + ST_n_content + "'," +
