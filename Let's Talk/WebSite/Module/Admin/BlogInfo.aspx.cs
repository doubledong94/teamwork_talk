...
public partial class Module_Admin_BlogInfo : Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter mydataadapter = new SqlDataAdapter("select * from tb_Blog where BlogID=" + Request["id"],
                                                              mycon);
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        string P_str_Com = "update tb_Blog set UserName='" + txtName.Text + "',PassWord='" + txtOKpwd.Text + "',Sex='" +
                           ddlSex.SelectedValue + "',ReallyName='" + txtRealName.Text + "',Email='" + txtEmail.Text +
                           "',HomePhone='" + txtHphone.Text + "',MobilePhone='" + txtMphone.Text + "',PostCode='" +
                           txtPostCode.Text + "',Address='" + txtAddress.Text + "',Answer='" + txtAns.Text +
                           "',Subject='" + txtSubject.Text + "',Question='" + txtQues.Text + "' where BlogID='" +
                           Request["id"] + "'";
