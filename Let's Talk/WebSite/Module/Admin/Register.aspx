        ...
        <form id="form1" runat="server">
            <div style="text-align: center; vertical-align: top;" align="left">
                <table style="width: 311px" cellpadding="0" cellspacing="0" align="left">
                    ...
                    <tr>
                        <td colspan="3" style="background-repeat: no-repeat; height: 465px; text-align: center;" align="left">
                            <table style="border-bottom-color: black; border-bottom-width: thin; border-left-color: black; border-left-width: thin; border-right-color: black; border-right-width: thin; border-top-color: black; border-top-width: thin; vertical-align: top; width: 392px;" id="TABLE1" runat="server" align="left">
                                <tr>
                                ...
                                <tr style="font-size: 12pt">
                                    ...
                                    <td colspan="2" style="font-size: 9pt; height: 21px; text-align: center; width: 16px;">
                                        <asp:TextBox ID="txtPwd" runat="server" Width="117px" TextMode="Password" Font-Size="9pt"></asp:TextBox></td>
                                    <td colspan="1" style="font-size: 9pt; height: 21px; text-align: left; width: 173px;">
                                ...
                                <tr style="color: #000000; font-size: 9pt;">
                                    <td style="height: 17px; text-align: center; width: 82px;">
                                        <span>
                                            确认密码:</span></td>
                                    <td colspan="2" style="height: 17px; text-align: center; width: 16px;">
