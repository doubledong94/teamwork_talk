    ...
    <body style="background-image: url(../../Images/SysSkin/right.jpg); text-align: center;">
        <form id="form1" runat="server">
            <div style="text-align: center">
                ...
                <br />
                &nbsp;</div>
            <table style="border-bottom: #afafaf 1px solid; border-left: #afafaf 1px solid; border-right: #afafaf 1px solid; border-top: #afafaf 1px solid; height: 346px; text-align: center; vertical-align: middle; width: 529px;" cellpadding="0" cellspacing="0">
                <tr>
