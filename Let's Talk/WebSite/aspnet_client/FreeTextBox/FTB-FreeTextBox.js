...
//FTB_FreeTextBox.prototype.Initialize = function() {
    ...
    if (this.designModeTab) {
        ...
        this.designModeTab.onclick = function() {
            if (!this.ftb.readOnly) {
                this.ftb.GoToDesignMode();
                this.ftb.Focus();
    ...
    if (this.htmlModeTab) {
        ...
        this.htmlModeTab.onclick = function() {
            if (!this.ftb.readOnly) {
                this.ftb.GoToHtmlMode();
                this.ftb.Focus();
                this.ftb.UpdateToolbars();
            }
        };
    ...
    if (this.previewModeTab) {
        ...
        this.previewModeTab.onclick = function() {
            if (!this.ftb.readOnly) {
                this.ftb.GoToPreviewMode();
            }
        };
    }
